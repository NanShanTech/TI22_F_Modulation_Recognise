...
# group APP
add_library(Group_APP INTERFACE)
target_include_directories(Group_APP INTERFACE
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_INCLUDE_DIRECTORIES>
  "${SOLUTION_ROOT}/../App"
)
target_compile_definitions(Group_APP INTERFACE
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_DEFINITIONS>
)
...
add_library(Group_Task OBJECT
  ...
  "${SOLUTION_ROOT}/../App/task/tasks.c"
)
...
# group DSP
add_library(Group_DSP OBJECT
  "${SOLUTION_ROOT}/../App/dsp/dsp_filter.c"
  "${SOLUTION_ROOT}/../App/dsp/dsp_adaptive.c"
  "${SOLUTION_ROOT}/../App/dsp/dsp_analyze.c"
)
target_include_directories(Group_DSP PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_INCLUDE_DIRECTORIES>
  "${SOLUTION_ROOT}/../App/dsp"
)
target_compile_definitions(Group_DSP PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_DEFINITIONS>
)
...
target_compile_options(Group_DSP PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_OPTIONS>
)
target_link_libraries(Group_DSP PUBLIC
  Group_DSP_ABSTRACTIONS
)
